...
import com.snail.abell.jwtLogin.security.dto.JwtUserDto;
import com.snail.abell.jwtLogin.security.dto.OnlineUserDto;
import com.snail.abell.utils.*;
...
public class OnlineUserService {
    ...
    public void save(JwtUserDto jwtUserDto, String token, HttpServletRequest request){
        ...
        redisUtils.set(JWTConfig.onlineKey + token, onlineUserDto, JWTConfig.expiration/1000);
    }
    ...
    public List<OnlineUserDto> getAll(String filter){
        List<String> keys = redisUtils.scan(JWTConfig.onlineKey + "*");
    ...
    public void logout(String token) {
        String key = JWTConfig.onlineKey + token;
        redisUtils.del(key);
    }
