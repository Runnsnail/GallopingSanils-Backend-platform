package com.snail.abell.jwtLogin.security;

import com.snail.abell.jwtLogin.security.entity.SelfUserEntity;
import com.snail.abell.jwtLogin.security.service.SelfUserDetailsService;
...
public class UserAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (userInfo.getEnabled().equals(0)){
        ...
        for (SysRole sysRoleEntity: sysRoleEntityList){
            authorities.add(new SimpleGrantedAuthority(sysRoleEntity.getName()));
        }
