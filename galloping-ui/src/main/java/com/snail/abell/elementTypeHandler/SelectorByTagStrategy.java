...
@SelectorTypeAnnotation(selectorType = SelectorType.TAG)
public class SelectorByTagStrategy implements SelectorStrategy {
    ...
    public List<WebElement> findElements(String byValue, WebDriver driver) {
        return driver.findElements(By.tagName(byValue));
    }
    ...
    public boolean exists(String byValue, WebDriver driver) {
        ...
        try {
            driver.findElement(By.tagName(byValue));
            // 设置查询组件等待时间
    ...
    public boolean elementsExists(String byValue, WebDriver driver) {
        return driver.findElements(By.tagName(byValue)).size() > 0;
    }
    ...
    public boolean getEnableState(String value, WebDriver driver) {
        return driver.findElement(By.tagName(value)).isEnabled();
    }

    @Override
    public boolean getSelectState(String value, WebDriver driver) {
        return driver.findElement(By.tagName(value)).isSelected();
    }
    ...
    public void clickByJs(String value, WebDriver driver) {
        clickByJs(driver.findElement(By.tagName(value)),driver);
    }
    ...
    public void simulationKeyboardOperation(WebDriver driver, String keysCodeOne, String keysCodeTwo) throws AWTException {
        driver.findElement(By.tagName("kw")).sendKeys(keysCodeOne, keysCodeTwo);
    }

    @Override
    public void keyboardOperation(WebDriver driver, String keysCode) throws AWTException {
        driver.findElement(By.tagName("kw")).sendKeys(keysCode);
    }

    @Override
    public void moveToElementBy(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(driver.findElement(By.tagName(value))).perform();
    }

    @Override
    public void rightClickWebElement(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.contextClick(driver.findElement(By.tagName(value))).perform();
    }
    ...
    public void doubleClickWebElement(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.doubleClick(driver.findElement(By.tagName(value))).perform();
    }
    ...
    public void moveToElementAndClick(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(driver.findElement(By.tagName(value))).click().perform();
    }
    ...
    public void clickHoldAndRelease(String value, WebDriver driver) {
        ...
        actions.release(driver.findElement(By.tagName(value))).perform();
    }
}
