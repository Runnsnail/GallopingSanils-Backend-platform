 ...
 * @date 2022/11/11
 */
@SelectorTypeAnnotation(selectorType = SelectorType.CSS)
public class SelectorByCssStrategy implements SelectorStrategy {
    ...
    public List<WebElement> findElements(String byValue, WebDriver driver) {
        return driver.findElements(By.cssSelector(byValue));
    }
    ...
    public boolean exists(String byValue, WebDriver driver) {
        ...
        try {
            driver.findElement(By.cssSelector(byValue));
            // 设置查询组件等待时间
    ...
    public boolean elementsExists(String byValue, WebDriver driver) {
        return driver.findElements(By.cssSelector(byValue)).size() > 0;
    }
    ...
    public boolean getEnableState(String value, WebDriver driver) {
        return driver.findElement(By.cssSelector(value)).isEnabled();
    }

    @Override
    public boolean getSelectState(String value, WebDriver driver) {
        return driver.findElement(By.cssSelector(value)).isSelected();
    }
    ...
    public void clickByJs(String value, WebDriver driver) {
        clickByJs(driver.findElement(By.cssSelector(value)),driver);
    }
    ...
    public void simulationKeyboardOperation(WebDriver driver, String keysCodeOne, String keysCodeTwo) throws AWTException {
        driver.findElement(By.cssSelector("kw")).sendKeys(keysCodeOne, keysCodeTwo);
    }

    @Override
    public void keyboardOperation(WebDriver driver, String keysCode) throws AWTException {
        driver.findElement(By.cssSelector("kw")).sendKeys(keysCode);
    }

    @Override
    public void moveToElementBy(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(driver.findElement(By.cssSelector(value))).perform();
    }

    @Override
    public void rightClickWebElement(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.contextClick(driver.findElement(By.cssSelector(value))).perform();
    }
    ...
    public void doubleClickWebElement(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.doubleClick(driver.findElement(By.cssSelector(value))).perform();
    }
    ...
    public void moveToElementAndClick(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(driver.findElement(By.cssSelector(value))).click().perform();
    }
    ...
    public void clickHoldAndRelease(String value, WebDriver driver, Long time) {
        ...
        actions.release(driver.findElement(By.cssSelector(value))).perform();
    }
}
