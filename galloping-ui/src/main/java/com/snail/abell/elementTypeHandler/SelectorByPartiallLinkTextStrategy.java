 ...
 * @date 2022/11/11
 */
@SelectorTypeAnnotation(selectorType = SelectorType.PARTIALLINKTEXT)
public class SelectorByPartiallLinkTextStrategy implements SelectorStrategy {
    ...
    public List<WebElement> findElements(String byValue, WebDriver driver) {
        return driver.findElements(By.partialLinkText(byValue));
    }
    ...
    public boolean exists(String byValue, WebDriver driver) {
        ...
        try {
            driver.findElement(By.partialLinkText(byValue));
            // 设置查询组件等待时间
    ...
    public boolean elementsExists(String byValue, WebDriver driver) {
        return driver.findElements(By.partialLinkText(byValue)).size() > 0;
    }
    ...
    public boolean getEnableState(String value, WebDriver driver) {
        return driver.findElement(By.partialLinkText(value)).isEnabled();
    }

    @Override
    public boolean getSelectState(String value, WebDriver driver) {
        return driver.findElement(By.partialLinkText(value)).isSelected();
    }
    ...
    public void clickByJs(String value, WebDriver driver) {
        clickByJs(driver.findElement(By.partialLinkText(value)),driver);
    }
    ...
    public void simulationKeyboardOperation(WebDriver driver, String keysCodeOne, String keysCodeTwo) throws AWTException {
        driver.findElement(By.partialLinkText("kw")).sendKeys(keysCodeOne, keysCodeTwo);
    }

    @Override
    public void keyboardOperation(WebDriver driver, String keysCode) throws AWTException {
        driver.findElement(By.partialLinkText("kw")).sendKeys(keysCode);
    }

    @Override
    public void moveToElementBy(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(driver.findElement(By.partialLinkText(value))).perform();
    }

    @Override
    public void rightClickWebElement(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.contextClick(driver.findElement(By.partialLinkText(value))).perform();
    }

    @Override
    public void leftClickWebElement(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.clickAndHold(driver.findElement(By.partialLinkText(value))).perform();
    }
    ...
    public void doubleClickWebElement(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.doubleClick(driver.findElement(By.partialLinkText(value))).perform();
    }
    ...
    public void moveToElementAndClick(String value, WebDriver driver) {
        Actions actions = new Actions(driver);
        actions.moveToElement(driver.findElement(By.partialLinkText(value))).click().perform();
    }
    ...
    public void clickHoldAndRelease(String value, WebDriver driver, Long time) {
        ...
        actions.release(driver.findElement(By.partialLinkText(value))).perform();
    }
}
